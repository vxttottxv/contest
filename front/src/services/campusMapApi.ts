...
export const MOCK_BUILDINGS: Building3D[] = [
  {
    id: 'bld-1',
    name: '본관 (Main Building)',
    code: 'A동',
    floors: 7,
    coordinates: { x: 50, y: 30 },
    description: '학사행정실, 유학생지원센터, 총장실 및 주요 대학 행정 부서가 위치한 본관입니다.',
    facilities: ['학사행정실', '학생식당', '교직원 식당', 'ATM인출기'],
    entrances: ['본관 정문 주출입구(1F)', '후면 연결통로(2F)'],
    classrooms: ['A101 세미나홀', 'A202 대강당', 'A305 글로벌 화상회의실'],
  },
  {
    id: 'bld-2',
    name: '공학관 (Engineering Hall)',
    code: 'B동',
    floors: 8,
    coordinates: { x: 25, y: 55 },
    description: '컴퓨터공학과, AI융합과, 실습실 및 IT 소프트웨어 랩실이 집중되어 있는 공학 학술동입니다.',
    facilities: ['24시간 무인 프린트실', 'CU 편의점', '학생 휴게라운지'],
    entrances: ['동측 중앙 입구(1F)', '서측 엘리베이터 입구(1F)'],
    classrooms: ['B104 AI컴퓨터랩', 'B301 SW코딩실습실', 'B402 캡스톤디자인실'],
  },
  {
    id: 'bld-3',
    name: '예체능관 (Arts & Sports Hall)',
    code: 'C동',
    floors: 5,
    coordinates: { x: 75, y: 55 },
    description: '실내 체육관, 디자인/미술 실습실, 음악/무용 연습실 및 실버 돔 아치 강당이 통합된 예체능 전용 공간입니다.',
    facilities: ['실내 체육관', '예술 전시홀', '북카페', '미디어 인쇄실'],
    entrances: ['예체능관 정문(1F)', '체육관 실버 돔 출입구(1F)'],
    classrooms: ['C101 종합 실내체육관', 'C202 미디어디자인실', 'C305 예술 실습실'],
  },
  {
    id: 'bld-4',
    name: '사회교육관 (Social Education Hall)',
    code: 'D동',
    floors: 12,
    coordinates: { x: 50, y: 80 },
    description: '사회과학 계열 강의실, 평생교육원, 유학생 기숙 주거공간 및 글로벌 다문화 라운지입니다.',
    facilities: ['사회교육관 학생식당', '글로벌 라운지', 'GS25 편의점', '스터디카페'],
    entrances: ['사회교육관 메인 출입구(1F)', '동측 보안 출입구(1F)'],
    classrooms: ['D101 유학생 커뮤니티홀', 'D201 사회교육 강의실', 'D305 언어교육 센터'],
  },
];
