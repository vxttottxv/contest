...
export default function AcademicsPage({ onBack }: AcademicsPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0d0d12] text-white flex flex-col font-sans selection:bg-white/20 pb-20 relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-white/[0.12] rounded-[100%] blur-[120px] animate-[pulse_10s_ease-in-out_infinite]" />
        <div className="absolute bottom-[-10%] right-[-20%] w-[60%] h-[60%] bg-white/[0.08] rounded-[100%] blur-[120px] animate-[pulse_12s_ease-in-out_infinite_reverse]" />
      </div>
      ...
      <main className="relative z-10 max-w-7xl w-full mx-auto px-6 pt-4 flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 auto-rows-min gap-4 md:gap-5">
          ...
          <motion.div 
            ...
            className="md:col-span-4 p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-transparent border border-white/[0.15] backdrop-blur-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.6),inset_0_1px_2px_0_rgba(255,255,255,0.2)] flex flex-col justify-between hover:bg-neutral-900/60 transition-colors"
          >
          ...
          <motion.div 
            ...
            className="md:col-span-8 p-6 md:p-8 rounded-3xl bg-gradient-to-br from-white/[0.08] to-transparent border border-white/[0.15] backdrop-blur-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.6),inset_0_1px_2px_0_rgba(255,255,255,0.2)] flex flex-col hover:bg-neutral-900/60 transition-colors relative overflow-hidden"
          >
          ...
          <motion.div 
            ...
            className="md:col-span-7 p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-transparent border border-white/[0.15] backdrop-blur-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.6),inset_0_1px_2px_0_rgba(255,255,255,0.2)] flex flex-col hover:bg-neutral-900/60 transition-colors"
          >
          ...
          <motion.div 
            ...
            className="md:col-span-5 p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-transparent border border-white/[0.15] backdrop-blur-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.6),inset_0_1px_2px_0_rgba(255,255,255,0.2)] flex flex-col hover:bg-neutral-900/60 transition-colors"
          >
          ...
          <motion.div 
            ...
            className="md:col-span-6 p-6 rounded-3xl bg-gradient-to-br from-white/[0.08] to-transparent border border-white/[0.15] backdrop-blur-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.6),inset_0_1px_2px_0_rgba(255,255,255,0.2)] flex flex-col hover:bg-neutral-900/60 transition-colors"
          >
